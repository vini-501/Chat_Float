          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
            ...
            <div className="text-white space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-blue-100 leading-relaxed max-w-lg">
                  Transform oceanographic data into actionable intelligence with advanced ML models and AI-driven predictions across environmental, biological, and operational domains.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                <div className="text-center">
                  ...
                  <div className="text-sm text-blue-200">Prediction Domains</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-cyan-300">95%</div>
                  <div className="text-sm text-blue-200">ML Accuracy</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-cyan-300">1000+</div>
                  <div className="text-sm text-blue-200">Ocean Profiles</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                {/* Ocean Visualization */}
                <div className="aspect-square bg-gradient-to-br from-cyan-400/20 to-blue-600/20 rounded-2xl p-6 relative overflow-hidden">
                  {/* Floating Elements */}
                    ...
                    {[...Array(15)].map((_, i) => (
                      <div
                        ...
                        className={`absolute w-3 h-3 rounded-full animate-float ${
                          i % 3 === 0 ? 'bg-cyan-300/60' : i % 3 === 1 ? 'bg-blue-300/60' : 'bg-indigo-300/60'
                        }`}
                        style={{
                  ...
                  {/* Corner Icons */}
                  <div className="absolute top-4 left-4 bg-white/80 rounded-full p-3">
                    <Thermometer className="h-6 w-6 text-orange-500" />
                  </div>
                  <div className="absolute top-4 right-4 bg-white/80 rounded-full p-3">
                    <Fish className="h-6 w-6 text-blue-500" />
                  </div>
                  <div className="absolute bottom-4 left-4 bg-white/80 rounded-full p-3">
                    <Globe className="h-6 w-6 text-green-500" />
                  </div>
                  <div className="absolute bottom-4 right-4 bg-white/80 rounded-full p-3">
